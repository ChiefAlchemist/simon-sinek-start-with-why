...
setupCaption.c1 = '<a href="http://autd.co/l3sqT" target="_blank"><i class="fa fa-twitter-square"></i> ChiefAlchemist1</a>'; 
setupCaption.c2 = '<a href="http://autd.co/c3Tg4" target="_blank"><i class="fa fa-facebook-square"></i> ChiefAlchemist</a>';
setupCaption.c3 = '<a href="http://autd.co/eg7uc" target="_blank"><i class="fa fa-pinterest-square"></i> ChiefAlchemist</a>';
setupCaption.c4 = '<a href="http://autd.co/FPD12" target="_blank"><i class="fa fa-globe"></i> ChiefAlchemist.com</a>';
